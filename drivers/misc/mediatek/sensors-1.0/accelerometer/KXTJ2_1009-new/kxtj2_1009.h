...
#define KXTJ2_1009_REG_DATAXLOW			0x06
...
/*----------------------------------------------------------------------------*/
struct KXTJ2_1009_CUST {
	uint16_t action;
};

/*----------------------------------------------------------------------------*/
struct KXTJ2_1009_SET_CUST {
	uint16_t action;
	uint16_t part;
	int32_t data[0];
};
/*----------------------------------------------------------------------------*/
struct KXTJ2_1009_SET_CALI {
	uint16_t action;
	int32_t data[KXTJ2_1009_AXES_NUM];
};
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
union KXTJ2_1009_CUST_DATA {
	uint32_t data[10];
	struct KXTJ2_1009_CUST cust;
	struct KXTJ2_1009_SET_CUST setCust;
	struct KXTJ2_1009_SET_CALI setCali;
	struct KXTJ2_1009_CUST resetCali;
};
/*----------------------------------------------------------------------------*/
